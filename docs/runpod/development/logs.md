...
> Learn how to access and manage logs for Serverless endpoints and workers.
...
The most straightforward approach for persistent logging is to write logs to a [network volume](/serverless/storage/network-volumes) attached to your endpoint.
