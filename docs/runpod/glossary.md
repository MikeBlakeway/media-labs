...
A [Runpod template](/pods/templates/overview) is a Docker container image paired with a configuration. Templates define the required container disk size, volume, volume paths, ports, and environment variables needed to launch Pods.
