          ...
          {status.readyNow ? (
            ...
            <div className='flex items-center gap-2'>
              ...
              {status.estimatedReadyTime && (
                <span className='text-gray-500'>(ready in {formatReadyTime(status.estimatedReadyTime)})</span>
              )}
            </div>
          )}
        </div>
        ...
        {status.readyNow ? (
          ...
          <div className='space-y-3'>
            <div className='flex items-center justify-between text-sm'>
              <span>Preparing {status.pendingModels.length} models...</span>
              {status.estimatedReadyTime && (
                <span className='text-gray-600'>Ready in {formatReadyTime(status.estimatedReadyTime)}</span>
              )}
            </div>
